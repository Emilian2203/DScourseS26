...
\begin{enumerate}
    ...
    \item Type
        ...
        where you replace \texttt{your-github-username} with your actual GitHub username (do not include the square brackets).
...
\begin{enumerate}
    ...
    \item Type \texttt{git clone git@github.com:your-github-username/DScourseS26.git} where you replace \texttt{your-github-username} with your actual GitHub username (do not include the square brackets).
...
\begin{itemize}
    \item \texttt{cd \~}
    \item \texttt{cd DScourseS26/ProblemSets/PS2} (note: you may need to create the \texttt{PS2} directory if it doesn't exist by typing \texttt{mkdir PS2} from within the \texttt{ProblemSets} directory)
